const __resolved__virtual_storySource_srcComponentsFeedbackTooltipTooltipStoryVue = `<script setup lang="ts">\r
import type { ElTooltipProps } from 'element-plus'\r
...
const basicSource = computed(() => {\r
  return \`<el-tooltip\${isAttribute(\r
...
>\r
  <el-button>el-tooltip</el-button>\r
</el-tooltip>\`\r
})\r
<\/script>\r
\r
<!-- icon from https://icones.js.org/collection/all?s=tooltip -->\r
<template>\r
  <Story title="Feedback/Tooltip" icon="mdi:tooltip-minus-outline">\r
    <Variant\r
      title="Basic Usage"\r
    ...
    >\r
      <el-tooltip\r
        ...
        :content="basicData.content"\r
        :raw-content="basicData.rawContent"\r
        :placement="basicData.placement"\r
        :visible="basicData.visible"\r
      ...
      <template #controls>\r
        ...
        />\r
        <HstCheckbox v-model="basicData.rawContent" title="raw-content" />\r
        <HstText\r
...
`;
export {
  __resolved__virtual_storySource_srcComponentsFeedbackTooltipTooltipStoryVue as default
};
