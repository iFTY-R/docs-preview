      ...
      createVNode(_component_Variant, {
        ...
        controls: withCtx(() => [
          ...
          createVNode(_component_HstSelect, {
            ...
            "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => $setup.basicData.placement = $event),
            title: "placement",
          ...
          createVNode(_component_HstButtonGroup, {
            ...
            "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => $setup.basicData.visible = $event),
          ...
          createVNode(_component_HstNumber, {
            ...
            "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => $setup.basicData.offset = $event),
            title: "offset"
          }, null, 8, ["modelValue"]),
          createVNode(_component_HstNumber, {
            modelValue: $setup.basicData.showAfter,
            "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => $setup.basicData.showAfter = $event),
            title: "show-after"
          }, null, 8, ["modelValue"]),
          createVNode(_component_HstNumber, {
            modelValue: $setup.basicData.hideAfter,
            "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => $setup.basicData.hideAfter = $event),
            title: "hide-after"
          }, null, 8, ["modelValue"]),
          createVNode(_component_HstCheckbox, {
            modelValue: $setup.basicData.showArrow,
            "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => $setup.basicData.showArrow = $event),
            title: "show-arrow"
          }, null, 8, ["modelValue"]),
          createVNode(_component_HstCheckbox, {
            modelValue: $setup.basicData.enterable,
            "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => $setup.basicData.enterable = $event),
            title: "enterable"
          }, null, 8, ["modelValue"]),
          createVNode(_component_HstSelect, {
            modelValue: $setup.basicData.trigger,
            "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => $setup.basicData.trigger = $event),
            title: "trigger",
            options: [
              {
                value: "hover",
        ...
        default: withCtx(() => [
          createVNode(_component_el_popover, {
            ...
            _: 1
            /* STABLE */
          }, 8, ["effect", "content", "placement", "visible", "disabled", "offset", "show-after", "show-arrow", "hide-after", "enterable", "trigger"])
        ]),
        _: 1
        /* STABLE */
      }, 8, ["source"])
...
_sfc_main.__file = "src/components/Feedback/Popover/popover.story.vue";
const popover_story = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/WorkSpace/pure-admin/element-plus-interactive-docs/src/components/Feedback/Popover/popover.story.vue"]]);
export {
